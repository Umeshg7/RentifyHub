...
const Footer = () => {
  ...
  return (
    <div className="bg-grey1 text-white">
      <footer className="footer xl:px-24 py-10 px-4 text-base-content">
        <aside>
          <img src="/logo1.png" style={{ width: '250px', height: 'auto' }} alt="" />
        ...
        <nav>
          ...
          <a href="/products" className="link link-hover">View Products</a>
          <a href="/order" className="link link-hover">Order Tracking</a>
        </nav>
        <nav>
          <header className="footer-title">Contact Us</header>
          <a href="https://www.facebook.com/khetibazaar" className="link link-hover">Facebook</a>
          <a href="https://www.whatsapp.com/" className="link link-hover">Whatsapp</a>
          <a href="https://www.gmail.com" className="link link-hover">khetibazaar@email.com</a>
          <a className="link link-hover">+977 9876543210</a>
        </nav>
      </footer>
      <hr />
      <footer className="footer items-center xl:px-24 px-4 py-4 mt-2 text-black">
